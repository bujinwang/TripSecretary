...
echo "1. 检查屏幕文件..."
echo "----------------------------"
check_file "app/screens/taiwan/TaiwanInfoScreen.js"
check_file "app/screens/taiwan/TaiwanRequirementsScreen.js"
check_file "app/screens/singapore/SingaporeInfoScreen.js"
check_file "app/screens/singapore/SingaporeRequirementsScreen.js"
check_file "app/screens/malaysia/MalaysiaInfoScreen.js"
check_file "app/screens/malaysia/MalaysiaRequirementsScreen.js"
echo ""

echo "2. 检查导出配置..."
echo "----------------------------"
check_content "app/screens/taiwan/index.js" "TaiwanInfoScreen" "台湾 InfoScreen 已导出"
check_content "app/screens/taiwan/index.js" "TaiwanRequirementsScreen" "台湾 RequirementsScreen 已导出"
check_content "app/screens/singapore/index.js" "SingaporeInfoScreen" "新加坡 InfoScreen 已导出"
check_content "app/screens/singapore/index.js" "SingaporeRequirementsScreen" "新加坡 RequirementsScreen 已导出"
check_content "app/screens/malaysia/index.js" "MalaysiaInfoScreen" "马来西亚 InfoScreen 已导出"
check_content "app/screens/malaysia/index.js" "MalaysiaRequirementsScreen" "马来西亚 RequirementsScreen 已导出"
echo ""

echo "3. 检查主导出文件..."
echo "----------------------------"
check_content "app/screens/index.js" "export \* from './taiwan'" "台湾屏幕已在主导出中"
check_content "app/screens/index.js" "export \* from './singapore'" "新加坡屏幕已在主导出中"
check_content "app/screens/index.js" "export \* from './malaysia'" "马来西亚屏幕已在主导出中"
echo ""
...
echo "5. 检查目的地配置..."
echo "----------------------------"
check_content "app/screens/SelectDestinationScreen.js" "id: 'tw'.*enabled: true" "台湾已在目的地列表中启用"
check_content "app/screens/SelectDestinationScreen.js" "id: 'sg'.*enabled: true" "新加坡已在目的地列表中启用"
check_content "app/screens/SelectDestinationScreen.js" "id: 'my'.*enabled: true" "马来西亚已在目的地列表中启用"
echo ""

echo "6. 检查导航逻辑..."
echo "----------------------------"
check_content "app/screens/SelectDestinationScreen.js" "navigate('TaiwanInfo'" "台湾导航到 InfoScreen"
check_content "app/screens/SelectDestinationScreen.js" "navigate('SingaporeInfo'" "新加坡导航到 InfoScreen"
check_content "app/screens/SelectDestinationScreen.js" "navigate('MalaysiaInfo'" "马来西亚导航到 InfoScreen"
echo ""
