...
# Read the file
with open('app/screens/hongkong/HongkongTravelInfoScreen.js', 'r', encoding='utf-8') as f:
    content = f.read()
    lines = content.split('\n')
...
with open('app/screens/hongkong/HongkongTravelInfoScreen.js', 'w', encoding='utf-8') as f:
    f.write('\n'.join(new_lines))
