...
const baseTranslations = {
  ...
  zh: {
    ...
    malaysia: {
      ...
      entryPackPreview: {
        headerTitle: '马来西亚入境包 - 预览',
        previewMode: '预览模式',
        previewDescription: '这是您的入境信息预览。提交MDAC数字入境卡后，将包含完整的入境卡详情。',
        continueButton: '继续完善信息 ✏️',
        submitButton: '提交MDAC入境卡 🇲🇾',
        infoTip: '提示：确保所有信息准确无误后再提交MDAC。入境卡需要在抵达前3天内提交。',
      },
      entryFlow: {
        title: '马来西亚入境准备',
        preparationTitle: '马来西亚之旅准备',
        subtitle: '查看您的入境信息完成情况',
        loading: '正在加载准备状态...',
        categories: {
          passport: '护照信息',
          personal: '个人信息',
        ...
        actions: {
          submitMDAC: '提交MDAC入境卡',
          continueImproving: '继续完善信息',
          viewPreview: '查看入境卡预览',
          share: '找亲友帮忙填写',
        },
        noData: {
          title: '让我们开始准备马来西亚之旅吧！',
          description: '您还没有填写任何入境信息。点击下方按钮开始填写，我们将引导您完成整个过程。',
          startButton: '开始我的马来西亚准备之旅！',
        },
        notice: '马来西亚入境卡(MDAC)需要完整的个人和旅行信息。请确保所有信息准确无误。',
        privacy: '您的所有信息仅保存在手机本地，我们不会上传到任何服务器。',
      },
      travelInfo: {
        sections: {
          passport: '护照信息',
    ...
    singapore: {
      entryPackPreview: {
        headerTitle: '新加坡通关包 - 预览 / Entry Pack Preview',
        previewMode: '预览模式 / Preview Mode',
        previewDescription: '这是您的入境信息预览。提交SGAC入境卡后，将包含完整的入境卡详情。',
        continueButton: '返回继续完善信息 ✏️ / Continue updating info',
        submitButton: '提交新加坡入境卡 SGAC 🌴 / Submit SGAC entry card',
        infoTip: '💡 提示：SGAC可在抵达前3天到抵达后15天内提交。请确保所有信息准确无误。',
        infoTipEn: 'Tip: SGAC can be submitted 3 days before to 15 days after arrival. Please ensure all information is accurate.',
      },
      entryFlow: {
        title: '新加坡入境准备',
        updateButton: '更新我的新加坡准备信息 🌺',
        updateHint: '你的信息有更新，让我们重新准备最新的入境卡',
        continueButton: '继续准备我的新加坡之旅 💪',
        arrivalDateButton: '告诉我你什么时候到新加坡 ✈️',
        arrivalDateHint: '设置抵达日期，我们就能帮你找到最佳提交时间',
        readyButton: '准备好入境新加坡了！🌴',
        tripTitle: '我的新加坡之旅 🌺',
        startTitle: '准备开始新加坡之旅吧！🌴',
        prepareTitle: '新加坡入境需要准备这些信息 🌺',
        hints: {
          passport: '你的护照信息 📕',
          personal: '基本个人信息 👤',
          travel: '航班和住宿信息 ✈️',
        ...
        startButton: '开始我的新加坡准备之旅！🇸🇬',
        progressTitle: '我的新加坡准备进度 🌴',
        submissionTitle: '最佳提交时间 ⏰',
        nextStepsTitle: '接下来做什么？🌟',
        previewCard: {
          title: '看看我的入境卡长啥样 👁️',
          description: '预览你的SGAC入境卡信息',
        },
        shareCard: {
          title: '和朋友一起准备 📤',
          description: '分享给家人或朋友帮忙',
        },
        guideCard: {
          title: '新加坡入境资讯 📚',
          description: '了解新加坡入境流程',
        },
        guideButton: '查看新加坡入境指引',
        guideDescription: '完整6步骤入境流程，从SGAC提交到海关检查',
        entryPackButton: '看看我的通关包',
        entryPackDescription: '预览护照、SGAC二维码和资金证明',
      },
    },
    korea: {
      entryPackPreview: {
        headerTitle: '韩国入境包 - 预览',
        previewMode: '预览模式',
        previewDescription: '这是您的入境信息预览。K-ETA申请提交后，将包含完整的入境许可详情。',
        continueButton: '继续完善信息 ✏️',
        submitButton: 'K-ETA 申请即将推出 🇰🇷',
        infoTip: '提示：K-ETA电子旅行许可需要在出发前申请。目前该功能正在开发中。',
        ketaCardTitle: '📱 K-ETA 电子旅行许可信息',
        ketaCardDescription: 'K-ETA是韩国的电子旅行许可系统，允许免签国家公民在线申请入境许可。',
        ketaNotice: '• 有效期：2年\n• 停留时间：每次最多90天\n• 申请费用：约10,000韩元\n• K-ETA申请功能即将推出',
      },
    },
    thailand: {
