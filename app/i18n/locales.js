...
export const translations = {
  en: {
    ...
    copyWriteMode: {
      ...
      description: 'Screen will stay on, won\'t auto-lock\nTake your time, no rush',
      fontSizeLabel: 'Font Size:',
      instructionsTitle: 'Instructions',
      step1: '1. Get a blank entry card and customs declaration on the plane or at the immigration hall',
      step2: '2. Reference the content on your phone screen and copy it onto the paper form with a pen',
      step3: '3. Fill out the fields in the order shown on the form, from top to bottom',
      step4: '4. After completing, hand the forms to the immigration officer',
    },
    login: {
    ...
    immigrationGuide: {
      ...
      japanSteps: {
        ...
        step2: {
          ...
          description: 'Fill out blue entry card with black or blue pen',
          ...
          formPlaceholderText: 'Blue Entry Card',
  ...
  zh: {
    ...
    copyWriteMode: {
      ...
      description: '屏幕会保持常亮，不会自动锁屏\n您可以慢慢抄写，不用着急',
      fontSizeLabel: '字体大小：',
      instructionsTitle: '使用说明',
      step1: '1. 在飞机上或入境大厅拿一张空白的入境卡和海关申报单',
      step2: '2. 对照手机屏幕上的内容，用笔抄写到纸质表格上',
      step3: '3. 字段按照表格的顺序排列，从上到下依次填写',
      step4: '4. 填写完成后，交给入境官员',
    },
    login: {
      hotlistLabel: '热门目的地',
