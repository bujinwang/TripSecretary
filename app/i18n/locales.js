...
export const translations = {
  en: {
    ...
    immigrationGuide: {
      ...
      step1Title: '📋 Step 1: Get Forms',
      step1Description: 'Find entry card and customs declaration',
      step1Instruction: 'Find counters with "Entry Card" and "Customs"',
      step2Title: '✍️ Step 2: Fill Entry Card',
      step2Description: 'Fill blue entry card with pen',
      step2Instruction: 'Copy info from phone to form carefully',
      step2ViewButton: 'Fill Entry Form',
      step3Title: '📝 Step 3: Fill Declaration',
      step3Description: 'Fill yellow customs declaration',
      step3Instruction: 'Declare items honestly',
      step3ViewButton: 'Fill Declaration',
      step4Title: '🏢 Step 4: Immigration Check',
      step4Description: 'Go to immigration counter',
      step4Instruction: 'Queue and wait for officer',
      step5Title: '👤 Step 5: Biometric Scan',
      step5Description: 'Fingerprint and face scan',
      step5Instruction: 'Follow officer instructions',
      step6Title: '🛃 Step 6: Customs Inspection',
      step6Description: 'Go to customs area',
      step6Instruction: 'May need luggage inspection',
      step7Title: '✅ Step 7: Entry Complete',
      step7Description: 'Entry pack for use when needed',
      step7Instruction: 'Use entry pack if officer asks questions or language difficulty',
    },
  },
  zh: {
    languages: {
    ...
    immigrationGuide: {
      ...
      step1Title: '📋 第一步：领取表格',
      step1Description: '在入境大厅找到入境卡和海关申报单',
      step1Instruction: '找到标有"入境卡"和"海关申报"的柜台或自动发放机',
      step2Title: '✍️ 第二步：填写入境卡',
      step2Description: '用黑色或蓝色笔填写蓝色入境卡',
      step2Instruction: '对照手机上的信息，仔细抄写到表格上',
      step2ViewButton: '对照填写入境表',
      step3Title: '📝 第三步：填写海关申报单',
      step3Description: '填写黄色海关申报单',
      step3Instruction: '如实申报携带物品，回答是否有违禁品等问题',
      step3ViewButton: '对照填写申报表',
      step4Title: '🏢 第四步：前往入境审查',
      step4Description: '拿着填好的表格前往入境审查柜台',
      step4Instruction: '排队等待叫号，交给工作人员检查',
      step5Title: '👤 第五步：生物识别检查',
      step5Description: '接受指纹和面部识别',
      step5Instruction: '按照工作人员指示完成生物识别',
      step6Title: '🛃 第六步：海关检查',
      step6Description: '前往海关检查区',
      step6Instruction: '可能需要开箱检查行李，请耐心等待',
      step7Title: '✅ 第七步：完成入境',
      step7Description: '通关包仅在需要时使用',
      step7Instruction: '如果移民官员询问信息或遇到语言困难，可以打开通关包辅助沟通',
    },
  },
  fr: {
    languages: {
