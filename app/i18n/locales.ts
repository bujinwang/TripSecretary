...
const baseTranslations = {
  ...
  fr: {
    ...
    login: {
      ...
      heroCard: {
        title: 'Remplissez une fois, voyagez partout',
        description: 'Passeport, visa, formulaires d\'entrée—saisissez une fois, génération automatique pour chaque pays. Préparez toute l\'entrée en quelques minutes avant le départ, économisez 90% du temps.',
      },
      features: {
        digitalPack: 'Pack d\'entrée numérique',
        voiceAssistant: 'Assistant vocal intelligent',
        entryNavigation: 'Navigation d\'entrée',
      },
      ...
      whisperText: '💬 Vous ennuyez ? Vous pouvez discuter avec votre assistant 😄',
    ...
    home: {
      ...
      destinationNames: { jp: 'Japon', th: 'Thaïlande', hk: 'Hong Kong', tw: 'Taïwan', kr: 'Corée du Sud', my: 'Malaisie', vn: 'Viêt Nam', us: 'États-Unis' },
      destinations: { japan: { flightTime: 'Vol de 3 heures' }, thailand: { flightTime: 'Vol de 3 heures' }, hongKong: { flightTime: 'Vol de 1 heure' }, taiwan: { flightTime: 'Vol de 2 heures' }, korea: { flightTime: 'Vol de 2 heures' }, malaysia: { flightTime: 'Vol de 4 heures' }, vietnam: { flightTime: 'Vol de 3.5 heures' }, usa: { flightTime: 'Vol de 13 heures' } },
  ...
  de: {
    ...
    login: {
      ...
      heroCard: {
        title: 'Einmal ausfüllen, überall reisen',
        description: 'Reisepass, Visum, Einreiseformulare—einmal eingeben, automatisch für jedes Land generieren. Bereiten Sie alle Einreisen in Minuten vor der Abreise vor, sparen Sie 90% der Zeit.',
      },
      features: {
        digitalPack: 'Digitales Einreisepaket',
        voiceAssistant: 'Intelligenter Sprachassistent',
        entryNavigation: 'Einreisenavigation',
      },
      ...
      whisperText: '💬 Gelangweilt? Sie können mit Ihrem Assistenten chatten 😄',
    ...
    home: {
      ...
      destinationNames: { jp: 'Japan', th: 'Thailand', hk: 'Hongkong', tw: 'Taiwan', kr: 'Südkorea', my: 'Malaysia', vn: 'Vietnam', us: 'USA' },
      destinations: { japan: { flightTime: '3 Std. Flug' }, thailand: { flightTime: '3 Std. Flug' }, hongKong: { flightTime: '1 Std. Flug' }, taiwan: { flightTime: '2 Std. Flug' }, korea: { flightTime: '2 Std. Flug' }, malaysia: { flightTime: '4 Std. Flug' }, vietnam: { flightTime: '3.5 Std. Flug' }, usa: { flightTime: '13 Std. Flug' } },
  ...
  es: {
    ...
    login: {
      ...
      heroCard: {
        title: 'Completa una vez, viaja a todas partes',
        description: 'Pasaporte, visa, formularios de entrada—ingresa una vez, generación automática para cada país. Completa toda la preparación de entrada en minutos antes de la salida, ahorra 90% del tiempo.',
      },
      features: {
        digitalPack: 'Paquete de entrada digital',
        voiceAssistant: 'Asistente de voz inteligente',
        entryNavigation: 'Navegación de entrada',
      },
      ...
      whisperText: '💬 ¿Aburrido? Puedes chatear con tu asistente 😄',
    ...
    home: {
      ...
      destinationNames: { jp: 'Japón', th: 'Tailandia', hk: 'Hong Kong', tw: 'Taiwán', kr: 'Corea del Sur', my: 'Malasia', vn: 'Vietnam', us: 'EE.UU.' },
      destinations: { japan: { flightTime: '3 horas de vuelo' }, thailand: { flightTime: '3 horas de vuelo' }, hongKong: { flightTime: '1 hora de vuelo' }, taiwan: { flightTime: '2 horas de vuelo' }, korea: { flightTime: '2 horas de vuelo' }, malaysia: { flightTime: '4 horas de vuelo' }, vietnam: { flightTime: '3.5 horas de vuelo' }, usa: { flightTime: '13 horas de vuelo' } },
