...
import ThailandEntryGuideService from '../../entryGuide/ThailandEntryGuideService.js';
import USEntryGuideService from '../../entryGuide/USEntryGuideService.js';
import CanadaEntryGuideService from '../../entryGuide/CanadaEntryGuideService.js';
...
class SecurityAuditor {
  ...
  static auditConfigurationIntegrity() {
    ...
    // 检查配置文件是否可被外部修改
    const configFiles = [
      'app/config/entryGuide/thailand.js',
      'app/config/entryGuide/usa.js',
      'app/config/entryGuide/canada.js'
    ];
