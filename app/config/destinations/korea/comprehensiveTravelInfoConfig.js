...
export const koreaComprehensiveTravelInfoConfig = {
  ...
  navigation: {
    ...
    submitButton: {
      ...
      labels: {
        incomplete: 'kr.navigation.submitButton.incomplete',
        almostDone: 'kr.navigation.submitButton.almostDone',
        ready: 'kr.navigation.submitButton.ready',
      },

      default: 'kr.navigation.submitButton.default',
    },

    submitButtonLabel: {
      key: 'kr.travelInfo.submitButton',
      default: '保存并继续',
    },
  },
