 ...
 *
 * Configuration for JapanEntryFlowScreen template.
...
export const japanEntryFlowConfig = {
  ...
  screens: {
    ...
    submit: null, // Japan doesn't have digital arrival card submission
  ...
  ui: {
    ...
    noDataState: {
      enabled: true,
      defaultTitle: '准备开始日本之旅吧！',
      defaultSubtitle: '我们会一步步帮你完成所有必需的入境资料。',
      hints: [
        { icon: '📘', defaultText: '护照信息 - 让日本认识你' },
        { icon: '📞', defaultText: '联系方式 - 日本怎么找到你' },
    ...
    progressEncouragement: {
      ...
      statusMessages: {
        ...
        start: {
          ...
          subtitle: { default: '点击下方按钮，我们会引导你完成Japan入境准备。' },
        },
      },
      countdown: {
        enabled: true,
  ...
  status: {
    ready: {
      titleKey: 'japan.entryFlow.status.ready.title',
      subtitleKey: 'japan.entryFlow.status.ready.subtitle',
      defaultTitle: 'Ready for Entry!',
      defaultSubtitle: 'All information complete',
    },
    mostlyComplete: {
      titleKey: 'japan.entryFlow.status.mostlyComplete.title',
      subtitleKey: 'japan.entryFlow.status.mostlyComplete.subtitle',
      defaultTitle: 'Almost There',
      defaultSubtitle: 'A few more fields needed',
    },
    needsImprovement: {
      titleKey: 'japan.entryFlow.status.needsImprovement.title',
      subtitleKey: 'japan.entryFlow.status.needsImprovement.subtitle',
