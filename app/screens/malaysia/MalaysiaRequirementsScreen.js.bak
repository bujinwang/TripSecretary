  ...
  const requirementItems = useMemo(
    () => [
      ...
      },
      {
        ...
        title: t('malaysia.requirements.items.submissionWindow.title'),
        description: t('malaysia.requirements.items.submissionWindow.description'),
        details: t('malaysia.requirements.items.submissionWindow.details'),
      },
      {
        key: 'contactableEmail',
        title: t('malaysia.requirements.items.contactableEmail.title'),
        description: t('malaysia.requirements.items.contactableEmail.description'),
        details: t('malaysia.requirements.items.contactableEmail.details'),
      },
      {
        key: 'travelDetails',
        title: t('malaysia.requirements.items.travelDetails.title'),
        description: t('malaysia.requirements.items.travelDetails.description'),
        details: t('malaysia.requirements.items.travelDetails.details'),
      },
      {
        key: 'captchaReady',
        title: t('malaysia.requirements.items.captchaReady.title'),
        description: t('malaysia.requirements.items.captchaReady.description'),
        details: t('malaysia.requirements.items.captchaReady.details'),
      },
    ],
    [t]
  );
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            ...
            >
              {t('malaysia.requirements.continueButton')}
            </Text>
          </TouchableOpacity>
        </View>
