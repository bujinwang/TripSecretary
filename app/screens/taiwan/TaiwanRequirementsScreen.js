// 入境通 - Taiwan Requirements Screen (台湾入境要求确认)
...
const TaiwanRequirementsScreen = ({ navigation, route }) => {
  ...
  const requirementItems = useMemo(
    () => [
      {
        key: 'entryPermit',
        title: t('taiwan.requirements.items.entryPermit.title'),
        description: t('taiwan.requirements.items.entryPermit.description'),
        details: t('taiwan.requirements.items.entryPermit.details'),
      },
      {
        key: 'validPassport',
      ...
      {
        key: 'returnTicket',
        title: t('taiwan.requirements.items.returnTicket.title'),
        description: t('taiwan.requirements.items.returnTicket.description'),
        details: t('taiwan.requirements.items.returnTicket.details'),
      },
      {
        key: 'accommodation',
        title: t('taiwan.requirements.items.accommodation.title'),
        description: t('taiwan.requirements.items.accommodation.description'),
        details: t('taiwan.requirements.items.accommodation.details'),
      },
    ],
    [t]
  );
        ...
        <View style={styles.statusSection}>
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              {t('taiwan.requirements.status.info.title')}
            </Text>
            <Text style={styles.infoSubtext}>
              {t('taiwan.requirements.status.info.subtitle')}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={styles.continueButtonText}>
              {t('taiwan.requirements.startButton')}
            </Text>
          </TouchableOpacity>
        </View>
