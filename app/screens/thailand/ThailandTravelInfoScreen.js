    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <PassportSection
          ...
          onNameBlur={() => handleFieldBlur('fullName', [surname, middleName, givenName].filter(Boolean).join(', '))}
          errors={errors}
          warnings={warnings}
          nationality={nationality}
          onNationalityChange={setNationality}
          onDebouncedSave={debouncedSaveData}
          passportNo={passportNo}
          onPassportNoChange={setPassportNo}
          onFieldBlur={handleFieldBlur}
          visaNumber={visaNumber}
          onVisaNumberChange={setVisaNumber}
          dob={dob}
          onDobChange={setDob}
          expiryDate={expiryDate}
        ...
        <PersonalInfoSection
          ...
          cityOfResidence={cityOfResidence}
          onCityOfResidenceChange={setCityOfResidence}
          ...
          residentCountry={residentCountry}
          onResidentCountryChange={setResidentCountry}
          onPhoneCodeChange={(code) => setPhoneCode(getPhoneCode(code))}
          onDebouncedSave={debouncedSaveData}
          phoneCode={phoneCode}
          onPhoneCodeDirectChange={setPhoneCode}
          phoneNumber={phoneNumber}
        ...
        <FundsSection
          ...
          onAddFund={addFund}
          funds={funds}
          onFundItemPress={handleFundItemPress}
          t={t}
        />
        ...
        <TravelSection
          ...
          onTravelPurposeChange={handleTravelPurposeChange}
          customTravelPurpose={customTravelPurpose}
          onCustomTravelPurposeChange={setCustomTravelPurpose}
          onDebouncedSave={debouncedSaveData}
          onFieldBlur={handleFieldBlur}
          recentStayCountry={recentStayCountry}
          onRecentStayCountryChange={handleRecentStayCountryChange}
          boardingCountry={boardingCountry}
          onBoardingCountryChange={handleBoardingCountryChange}
          errors={errors}
          warnings={warnings}
          lastEditedField={lastEditedField}
          arrivalFlightNumber={arrivalFlightNumber}
          onArrivalFlightNumberChange={setArrivalFlightNumber}
          arrivalArrivalDate={arrivalArrivalDate}
          onArrivalDateChange={handleArrivalDateChange}
          departureFlightNumber={departureFlightNumber}
          onDepartureFlightNumberChange={setDepartureFlightNumber}
          departureDepartureDate={departureDepartureDate}
          onDepartureDateChange={handleDepartureDateChange}
          isTransitPassenger={isTransitPassenger}
          onTransitPassengerChange={handleTransitPassengerChange}
          accommodationType={accommodationType}
          onAccommodationTypeChange={handleAccommodationTypeChange}
          customAccommodationType={customAccommodationType}
          onCustomAccommodationTypeChange={setCustomAccommodationType}
          province={province}
