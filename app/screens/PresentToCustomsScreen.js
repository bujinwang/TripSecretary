// 出国啰 - Present to Customs Screen (向海关出示)
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.airportButtonContainer}>
          <TouchableOpacity
            style={styles.airportButton}
            onPress={() => navigation.navigate('AirportArrival', {
              passport,
              destination,
              travelInfo,
            })}
          >
            <Text style={styles.airportButtonIcon}>✈️</Text>
            <Text style={styles.airportButtonText}>我已到达机场</Text>
            <Text style={styles.airportButtonSubtext}>启动入境指南</Text>
          </TouchableOpacity>
        </View>

        {/* Footer */}
        <View style={styles.footer}>
          <Text style={styles.footerText}>Generated by TripSecretary</Text>
